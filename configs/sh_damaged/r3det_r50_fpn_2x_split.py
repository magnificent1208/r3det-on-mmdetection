...
merge_nms_iou_thr_dict = {
    'sh_damaged_half': 0.1, 'sh_damaged_comp-court': 0.3
}
...
# dataset settings
dataset_type = 'SH_DAMAGED_R3D'
classes = ('sh_damaged_half', 'sh_damaged_comp')
# dataset root path:
data_root = 'data/sh_damaged/'
...
img_norm_cfg = dict(
    mean=[143.85926711, 145.92965514, 138.12296977], 
    std=[40.75726325, 42.81147374, 45.26259844], to_rgb=True)
...
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/sh_damaged/r3det_r50_fpn_2x_split_210716'
